...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // COMPLETED (2) Add a new resource folder called visualizer_menu and create visualizer_menu.xml
    // COMPLETED (3) In visualizer_menu.xml create a visualizer_menu item with a single item. The id should be
    ...
    // COMPLETED (5) Add the visualizer_menu to the visualizer_menu bar
    @Override
    ...
    // COMPLETED (6) When the "Settings" visualizer_menu item is pressed, open SettingsActivity
    @Override
